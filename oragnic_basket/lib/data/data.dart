...
//ek  var data memory ma ave n change naithai , prog complie thai tyare j ave
  static final categories = [
    Category(id: 1, title: 'Vegetables', image: '', productModels: [
      ProductModel(title: 'Lady\'s Finger',itemPrice: 10),
      ProductModel(title: 'Brinjal',itemPrice: 20),
      ProductModel(title: 'Peas',itemPrice: 30),
      ProductModel(title: 'Onion',itemPrice: 40),
      ProductModel(title: 'Potato',itemPrice: 50),
    ]),
    Category(id: 2, title: 'Fruits', image: '', productModels: [
      ProductModel(title:'Apple',itemPrice: 10),
      ProductModel(title:'Banana',itemPrice: 20),
      ProductModel(title:'Mango',itemPrice: 20),
    ]),
